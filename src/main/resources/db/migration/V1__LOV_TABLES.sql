...
ALTER TABLE COUNTRY ADD CONSTRAINT COUNTRY_PK PRIMARY KEY ("COUNTRY_CODE") USING INDEX COUNTRY_PK ENABLE;
...
ALTER TABLE LOC ADD CONSTRAINT LOC_PK PRIMARY KEY ("ID") USING INDEX LOC_PK ENABLE;

CREATE UNIQUE INDEX UNIQUE_LOC_IDX ON LOC ("COMPANY_CODE", PLANT_NO, "LOC");
