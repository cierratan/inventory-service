...
ALTER TABLE "SIVDET_SUB"
    ADD CONSTRAINT "SIVDET_SUB_PK" PRIMARY KEY ("ID")
        USING INDEX "SIVDET_SUB_PK" ENABLE;

CREATE UNIQUE INDEX UNIQUE_SIVDET_SUB_IDX ON SIVDET_SUB ("COMPANY_CODE", "PLANT_NO", "SUB_TYPE", "SIV_NO", "SEQ_NO",
                                                         "DETAIL_SEQ");
